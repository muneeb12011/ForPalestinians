  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-card border-border">
        <CardHeader>
          <CardTitle className="text-lg font-semibold text-foreground">Real-time Statistics</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">Total Posts</span>
              <span className="text-primary font-semibold">{stats?.totalPosts || 0}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">Breaking News</span>
              <span className="text-red-500 font-semibold">{stats?.breakingNews || 0}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">Total Views</span>
              <span className="text-primary font-semibold">{stats?.totalViews || 0}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">Sources Monitored</span>
              <span className="text-primary font-semibold">{stats?.sourcesMonitored || 0}</span>
            </div>
            <div className="flex items-center justify-between">
      ...
      <Card className="bg-card border-border">
        <CardHeader>
          <CardTitle className="text-lg font-semibold text-foreground">Recent Quotes</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {quotes?.map((quote) => (
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="secondary" className="text-xs">2.8k</Badge>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">#Gaza</span>
              <Badge variant="secondary" className="text-xs">1.9k</Badge>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">#Occupation</span>
              <Badge variant="secondary" className="text-xs">1.2k</Badge>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">#HumanitarianCrisis</span>
              <Badge variant="secondary" className="text-xs">856</Badge>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">#InternationalLaw</span>
              <Badge variant="secondary" className="text-xs">634</Badge>
            </div>
          </div>
        </CardContent>
      </Card>
